...
Результаты в виде ссылки на репозиторий и публично доступный адрес присылайте на почту i.sidash@ffintech.com c темой письма **"Тестовое задание на позицию верстальщика"**. 
